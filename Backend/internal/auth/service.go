...
type ServiceConfig struct {
	...
	FamilyIDFactory     FamilyIDFactory
...
func NewService(cfg ServiceConfig) (*Service, error) {
	...
	if cfg.FamilyIDFactory == nil {
		cfg.FamilyIDFactory = func() (string, error) {
			raw := make([]byte, 16)
...
func (s *Service) issue(ctx context.Context, user User) (User, TokenPair, error) {
	...
	family, err := s.cfg.FamilyIDFactory()
	if err != nil || family == "" {
		return User{}, TokenPair{}, &ServiceError{"token_issue_failed", true, ErrRefreshTokenGeneration}
	}
